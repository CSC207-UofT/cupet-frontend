...
public class UserPetSlot2MatchingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_pet_slot2_matching);
        button = (Button) findViewById(R.id.edit_pet2_preferences_button);
        preference_button = (Button) findViewById(R.id.edit_pet2_preferences_button);
