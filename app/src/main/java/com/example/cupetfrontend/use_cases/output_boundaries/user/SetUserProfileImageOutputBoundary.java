...
import com.example.cupetfrontend.use_cases.response_models.pet.SetUserProfileImageSuccessResponseModel;
import com.example.cupetfrontend.use_cases.response_models.user.SetUserProfileImageFailResponseModel;
...
public interface SetUserProfileImageOutputBoundary {
     ...
     * @param response The response data
     */
    void onSetUserProfileImageFailure(SetUserProfileImageFailResponseModel response);
}